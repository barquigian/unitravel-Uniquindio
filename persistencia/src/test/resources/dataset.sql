...
insert into hotel values(1,"cra 02 #23-11","hotel Tertulia",4,"324234241","1",1);
insert into hotel values(2,"cra 02 #2-31","hotel Armenia",3,"324334241","1",1);
insert into hotel values(3,"cra 12 #2-21","hotel Cartagena",4,"314234241","2",2);
insert into hotel values(4,"cra 13 #3-31","hotel Cartagena 2",5,"32437241","2",2);
insert into hotel values(5,"cra 5 #43-10","hotel Cali",4,"334424241","2",3);
insert into hotel values(6,"cra 9 #34-56","hotel Cali Mirador",3,"31432241","2",3);
insert into hotel values(7,"cra 32 #8-21","hotel Medellin",5,"31243241","3",4);
insert into hotel values(8,"cra 24 #7-19","hotel Medallo",3,"31232341","3",4);
